...
SECRET_KEY = 'django-insecure-_05)*l0-n741ymg7-=&lcv!)j^i*8vt(h!wt$d^$nqune3$b(t'
...
CORS_ALLOW_CREDENTIALS = True  # Required for CSRF
...
MIDDLEWARE = [
    ...
    "users.middlewares.AllowOptionsMiddleware",  # Custom middleware for OPTIONS
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',  # ✅ Uses SQLite for internal Django features
