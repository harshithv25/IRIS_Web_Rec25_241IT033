...
class EquipmentView(APIView):
    ...
    def get(self, request):
        ...
        if (get_by == "admin_id" or get_by == "id" or get_by=="category" or get_by=="condition") and value:
            try:
                if get_by == '_id':
    ...
    def put(self, request):
        ...
        serializer = EquipmentSerializer(data=request.data)
        if serializer.is_valid():
            updated_equipment = Equipment.update(equipment_id, serializer.validated_data)
